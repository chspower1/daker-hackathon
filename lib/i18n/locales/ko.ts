...
export const ko: Dictionary = {
  ...
  campForm: {
    toggleOpen: "모집글 작성",
    toggleClose: "작성 닫기",
    createProfileTitle: "프로필 필요",
    createProfileDesc: "팀을 생성하려면 프로필이 필요합니다.",
    createProfileSuccessTitle: "프로필 준비 완료",
    createProfileSuccessDesc: "이제 모집글을 작성할 수 있습니다.",
    createProfileErrorTitle: "프로필을 저장할 수 없습니다",
    createProfileErrorDesc: "잠시 후 다시 시도해주세요.",
    createProfileBtn: "프로필 생성",
    createTeamTitle: "팀 생성",
    postingAs: "작성 프로필",
    teamName: "팀 이름",
    intro: "소개",
    lookingFor: "모집 분야 (쉼표로 구분)",
    lookingForPlaceholder: "프론트엔드, 디자이너",
    contactUrl: "연락처 URL",
    hackathonSlug: "해커톤",
    hackathonNone: "연결된 해커톤 없음",
    isOpen: "현재 모집 중",
    submit: "팀 생성",
    reset: "초기화",
    saveSuccessTitle: "모집글이 생성되었습니다",
    saveSuccessDesc: "새 모집글이 목록에 바로 반영되었습니다.",
    saveErrorTitle: "모집글을 저장할 수 없습니다",
  ...
  campList: {
    filterTitle: "해커톤 필터",
    filterDesc: "현재 표시 중인 모집글",
    ownerLabel: "작성자",
    hackathonLabel: "해커톤",
    statusLabel: "상태",
    statusOpen: "모집 중",
    statusClosed: "모집 마감",
    lookingForLabel: "모집 포지션",
    contactLabel: "연락 링크",
    contactLink: "링크 열기",
    createdAtLabel: "작성일"
  },
