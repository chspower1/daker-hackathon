export const en = {
  ...
  campForm: {
    toggleOpen: "Create team post",
    toggleClose: "Close form",
    createProfileTitle: "Profile Required",
    createProfileDesc: "You need a profile to create a team.",
    createProfileSuccessTitle: "Profile ready",
    createProfileSuccessDesc: "You can now create a team post.",
    ...
    submit: "Create Team",
    reset: "Reset",
    saveSuccessTitle: "Team post created",
    saveSuccessDesc: "Your team post is now visible in the list.",
    saveErrorTitle: "Unable to save the team post",
