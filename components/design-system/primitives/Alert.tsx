...
export const alertBaseClass = "relative w-full rounded-2xl border-2 p-5 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-md";
...
export function Alert({ className, variant = "default", title, children, ...props }: AlertProps) {
  return (
    <div
      role="alert"
      className={cn(alertBaseClass, alertVariants[variant], className)}
      {...props}
    >
